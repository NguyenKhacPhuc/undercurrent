...
/**
 * Semantic color tokens for Undercurrent's themes. Kept deliberately lean
 * (~12 slots) — the long tail of Material3's ColorScheme is derived from
 ...
 */
@Immutable
internal data class UndercurrentColors(
    /** Page background — the canvas under everything. */
    val background: Color,
    /** Slightly raised surface (drawer, sheets, cards). Often == background in document themes. */
    val surface: Color,
