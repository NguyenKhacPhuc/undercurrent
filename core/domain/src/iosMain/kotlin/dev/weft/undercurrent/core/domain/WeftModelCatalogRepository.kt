...
/**
 * iOS impl of [ModelCatalogRepository]. Identical to the Android impl —
 * the substrate's `catalogFor` / `defaultPoolFor` live in commonMain, so
 * both platforms project the same Koog [LLModel] catalog down to the
 * commonMain mirror. Replaces the earlier static stub.
 */
